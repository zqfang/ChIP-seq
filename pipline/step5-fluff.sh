...
# rep2
h3k27ac="${bwdir}/SRR1608987.ESC_rep2_H3K27ac.highQuality.sorted.bam"
h3k27me3="${bwdir}/SRR1608988.ESC_rep2_H3K27me3.highQuality.sorted.bam"
h3k4me3="${bwdir}/SRR1608989.ESC_rep2_H3K4me3.highQuality.sorted.bam"
h3k4me1="${bwdir}/SRR1608990.ESC_rep2_H3K4me1.highQuality.sorted.bam"

nh3k27ac="${bwdir}/SRR1608996.NE_rep2_H3K27ac.highQuality.sorted.bam"
nh3k27me3="${bwdir}/SRR1608997.NE_rep2_H3K27me3.highQuality.sorted.bam"
nh3k4me1="${bwdir}/SRR1608998.NE_rep2_H3K4me1.highQuality.sorted.bam"
nh3k4me3="${bwdir}/SRR1608999.NE_rep2_H3K4me3.highQuality.sorted.bam"


# region="/Users/bioninja/projects/SOX21_ChIP/enhancers/SOX21.peaks.tss.bed"

region="/Users/bioninja/projects/SOX21_ChIP/enhancers/SOX21.peaks.tss.bed"
region2="/Users/bioninja/projects/SOX21_ChIP/enhancers/SOX21.peaks.only.enhancers.bed"
mkdir -p fuff_out

fluff heatmap -f ${region} \
               -d ${S21_WT_IP} ${h3k4me3} ${h3k27me3} ${h3k27ac} ${nh3k4me3} ${nh3k27me3} ${nh3k27ac} \
               -o fuff_out/SOX21.tss.peaks.heatmap.fufll.k4.png \
              -c '#e41a1c','#377eb8','#4daf4a','#984ea3','#377eb8','#4daf4a','#984ea3' \
              -C kmeans -k 4 -e 5000

fluff heatmap -f ${region2} \
              -d ${S21_WT_IP} ${h3k4me1} ${h3k27me3} ${h3k27ac} ${nh3k4me1} ${nh3k27me3} ${nh3k27ac} \
              -o fuff_out/SOX21.enhancer.peaks.heatmap.fufll.k4.png \
              -c '#e41a1c','#377eb8','#4daf4a','#984ea3','#377eb8','#4daf4a','#984ea3' \
              -C kmeans -k 4 -e 5000
